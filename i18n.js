...
const I18N = {
  es: {
    ...
    nearby_no_results:        'No se encontraron aeropuertos europeos con coordenadas en ese radio.',
    nearby_results_summary:   (n, km, origin) => `<strong>${n}</strong> aeropuerto${n !== 1 ? 's' : ''} europeo${n !== 1 ? 's' : ''} en un radio de <strong>${km} km</strong> desde <strong>${origin}</strong>`,
  ...
  en: {
    ...
    nearby_no_results:        'No European airports with coordinates found within that radius.',
    nearby_results_summary:   (n, km, origin) => `<strong>${n}</strong> European airport${n !== 1 ? 's' : ''} within <strong>${km} km</strong> of <strong>${origin}</strong>`,
