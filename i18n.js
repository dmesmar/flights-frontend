...
const I18N = {
  es: {
    ...
    flex_extra_badge:     '± Flex',
    flex_extra_title:     'Día fuera del rango original (flexible ±N días)',
    multi_origin_title:   'Comparativa por origen (mín. €)',
    multi_origin_winner:  'Ganador',
    label_flex_range:     'Flexible ±',
    label_flex_days:      'días',
    tooltip_flex_range:   'Amplía la búsqueda N días antes y N días después del rango. Los días extra se marcan con etiqueta.',
    flex_days_aria:       'Días de flexibilidad (1 a 7)',
    airport_search_aria:  'Buscar aeropuerto',
    ...
    no_saved_flights:      'Aquí guardarás tus vuelos favoritos',
    no_saved_hint:         'Marca cualquier vuelo con ♥ desde una búsqueda y aparecerá aquí después.',
  ...
  en: {
    ...
    flex_extra_badge:     '± Flex',
    flex_extra_title:     'Day outside the original range (flexible ±N days)',
    multi_origin_title:   'Comparison by origin (min €)',
    multi_origin_winner:  'Winner',
    label_flex_range:     'Flexible ±',
    label_flex_days:      'days',
    tooltip_flex_range:   'Widens the search N days before and N days after the selected range. Extra days are tagged.',
    flex_days_aria:       'Flex days (1 to 7)',
    airport_search_aria:  'Search airport',
    ...
    no_saved_flights:      "This is where you'll keep your favorite flights",
    no_saved_hint:         'Tap ♥ on any flight in your search results to save it here.',
